...
public class VNameSpace {
	...
	HashMap<VNamedElement, String> map = new HashMap<VNamedElement, String>();
...
//	}
	...
	public String getUniqueName(VNamedElement el, String suggestedName) {
		...
		set.add(newName);
		map.put( (VNamedElement) el, newName );
		return newName;
	}
